...
class PixelSeeder extends Seeder
{
    public function run(): void
    {
        $pixels = [
            ...
            ["name" => "Google Pixel 9A 5G 128GB", "price" => 49000, "image_path" => "Images/google/pixel9a.jpg"],
            ["name" => "Google Pixel 9 Pro 5G 128GB", "price" => 64000, "image_path" => "Images/google/pixel9pro.jpg"],
            ["name" => "Google Pixel 9 Pro 5G 256GB", "price" => 68000, "image_path" => "Images/google/pixel9pro.jpg"],
        ];
