...
class VivoSeeder extends Seeder
{
    public function run(): void
    {
        $vivos = [
            // Y SERIES
            ["name" => "Vivo Y05 64GB + 4GB RAM", "price" => 19700, "image_path" => null],
            ["name" => "Vivo Y05 128GB + 4GB RAM", "price" => 21000, "image_path" => null],
            ["name" => "Vivo Y11d 128GB + 4GB RAM", "price" => 22800, "image_path" => null],
            ...
            ["name" => "Vivo Y500 256GB + 6GB RAM", "price" => 42400, "image_path" => null],
            ["name" => "Vivo Y500 256GB + 8GB RAM", "price" => 47500, "image_path" => null],
            ...
            ["name" => "Vivo V70 5G 256GB + 8GB RAM", "price" => 74200, "image_path" => "Images/vivo/vivov70.jpg"],
            ["name" => "Vivo V70 5G 512GB + 12GB RAM", "price" => 87600, "image_path" => "Images/vivo/vivov70.jpg"],

            // X SERIES
            ["name" => "Vivo X300 Pro 512GB + 16GB RAM", "price" => 153000, "image_path" => "Images/vivo/vivox300pro.jpg"],
        ];
