...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; } body { min-height:100vh; margin:0; color:var(--staff-ink); background:#f4f7f5; font-family:Arial,sans-serif; }
        ...
        .staff-logo { width:185px; height:48px; object-fit:contain; padding:4px 8px; border-radius:8px; background:#fff; } .staff-user { color:rgba(255,255,255,.68); font-size:.8rem; }
